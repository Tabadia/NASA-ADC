...
We used GitHub to sync code accross all our machines. This was the best option availible to us, but frequently caused merge conflicts and other issues. We had to restart entire game components at times!

## School Strike

The teachers union at our school striked the entire month of Novemember. This significantly affected us, since we weren't able to receive any of the NASA Office Hour Links from our mentor, who is a teacher, or recordings of previous meetings. Not only that, but we weren't able to meet at school either.
...
Started with a basic understanding of C# and nothing of Unity, Learned:

> Much more C#, the Unity game engine, Unity UI Toolkit, GameObjects and their properties
